...
public class Level3 implements Screen{
    ...
    private Texture BackgroundLevel3;
    ...
    public Level3 (SpiderEnemies game){
        this.game = game;
    }
    ...
    public void makeSpawn(){
        ...
        spawn.add(new Vector2(75,412-ENEMIES_HEIGHT));
        spawn.add(new Vector2(220,590-ENEMIES_HEIGHT));
        spawn.add(new Vector2(361,430-ENEMIES_HEIGHT));
        spawn.add(new Vector2(369,590-ENEMIES_HEIGHT));
        spawn.add(new Vector2(496,602-ENEMIES_HEIGHT)); 
        spawn.add(new Vector2(515,398-ENEMIES_HEIGHT));
        spawn.add(new Vector2(706,433-ENEMIES_HEIGHT));
        spawn.add(new Vector2(160,180-ENEMIES_HEIGHT));
        spawn.add(new Vector2(850,595-ENEMIES_HEIGHT));
    }  
    ...
    public void makeEnemies() {
        ...
        enemies.add(new Enemy(new Sprite(new Texture("scorpion2.png")), spawn, 150));
        enemies.add(new Enemy(new Sprite(new Texture("boss.png")), spawn, 150));
        enemies.add(new Enemy(new Sprite(new Texture("doctorstrange.png")), spawn, 150));
	...
	game.batch.begin();
        ...
        for (i=0;i < enemies.size; i++){
            ...
            if(enemy.animationIsPlaying){
                ...
                game.batch.draw((TextureRegion) enemy.animation.getKeyFrame(enemy.elapsedTime,true), enemy.ActualPosition.x,enemy.ActualPosition.y,100,100);
            ...
            if(enemy.hitAnimation.drawAnimation){  //Se l'animazione e' stata attivata, stampala
                ...
                game.batch.draw((TextureRegion) enemy.hitAnimation.animation.getKeyFrame(enemy.hitAnimation.elapsedTime,true), enemy.hitAnimation.ActualPosition.x+5,enemy.hitAnimation.ActualPosition.y,100,100);
                
                //Se l'animazione e' attiva stampa anche il numero di punti acquisiti cliccando il nemico
                if(enemy.x == 150){
                    font.getData().setScale(.25f,.25f);
                    font.draw(game.batch,"[GREEN]+150",enemy.hitAnimation.ActualPosition.x+15,enemy.hitAnimation.ActualPosition.y+80);
                } else if(enemy.x == 200){
                    font.getData().setScale(.25f,.25f);
                    font.draw(game.batch,"[GREEN]+200",enemy.hitAnimation.ActualPosition.x+15,enemy.hitAnimation.ActualPosition.y+80);                    
                } else if(enemy.x == -200){
                    font.getData().setScale(.25f,.25f);
                    font.draw(game.batch,"[RED]-200",enemy.hitAnimation.ActualPosition.x+15,enemy.hitAnimation.ActualPosition.y+80);                    
                }
        ...
        //Background
        game.batch.draw(BackgroundLevel3, 0, 0, SpiderEnemies.WIDTH, SpiderEnemies.HEIGHT);
